...
class SystemStack extends cdk.Stack {
     ...
     * @param {string} lambdasSubdir - subdirectory in .lib/assets/lambdas/ where the lambda code is located
     */
