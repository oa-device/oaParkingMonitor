...
class DashboardApiStack extends cdk.Stack {
   ...
   * @param {string} lambdasSubdir - subdirectory in ./assets/lambdas/ where the lambda code is located (e.g. "device" or "dashboard")
   */
  ...
  createStack(props, specs) {
    ...
    if (specs.lambdaSpecs) {
      for (let lambdaSpec of specs.lambdaSpecs) {
        ...
        StackHelpers.grantKmsAccess(this, lambda, lambdaSpec, props);
...
module.exports = { DashboardApiStack };